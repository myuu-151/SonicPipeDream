...
How the game is built: where things are, how the sky is made, and the docs for each part.
...
**Where it is (2026-09-23).** The game launches into the title menu; Main Game leads to the
...
| | |
| --- | --- |
| [docs/implementation-plan.md](implementation-plan.md) | **start here** -- the design, what is done and what is not, every phase left with a test for "done", and the decisions still open |
| [docs/procedural-stages.md](procedural-stages.md) | why a stage is a list of hand-shaped pieces, not a model |
| [docs/procedural-generation.md](procedural-generation.md) | the track generator: pieces, the deck, the difficulty rulebook |
| [docs/stage-generation.md](stage-generation.md) | the stage generator: sections, ring checks, the guarantee, colours, the marathon's hold |
| [docs/s2-special-stage-objects.md](s2-special-stage-objects.md) | the original's rings and bombs, decoded; the 93 modules; the checkers |
| [docs/s2-special-stage-layouts.md](s2-special-stage-layouts.md) | the original game's track data, decoded, and what it does and does not say |
| [docs/skies.md](skies.md) | the eight skies: which number is which, with a chart, and how to change one |
